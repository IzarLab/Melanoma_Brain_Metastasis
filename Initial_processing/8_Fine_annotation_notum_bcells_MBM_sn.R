...
seu$cell_type_fine <- ifelse(seu$integrated_snn_res.0.4 %in% c(0, 4, 3),
                             'Activated B cells', 'NA')
seu$cell_type_fine <- ifelse(seu$integrated_snn_res.1.3 %in% c(9), 'Naïve B cells',
                             seu$cell_type_fine)
seu$cell_type_fine <- ifelse(seu$integrated_snn_res.0.4 %in% c(1, 2), 'Plasma cells',
                             seu$cell_type_fine)
