...
#### Seurat re-intergation of single-cell samples 
...
# Save object
ifelse(!dir.exists(file.path('data/MBPM/sc/')), dir.create(file.path('data/MBPM/sc')), FALSE)
saveRDS(seu, file = 'data/MBPM/sc/data_MBPM_sc_notum.rds')
