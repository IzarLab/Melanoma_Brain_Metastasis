...
ifelse(!dir.exists(file.path('data/MBPM/IG_analysis')), dir.create(file.path('data/MBPM/IG_analysis'), recursive = T), FALSE)
write.csv(res_con, 'data/MBPM/IG_analysis/table_IG_MBPM_bcells_chains.csv', row.names = F, quote = F)

# Save heatmap of combination frequencies
...
# Print bar plot of light-chain usage in each patient, sorted by overall light
